...
class StrangerPanel extends ConsumerWidget {
  final String targetUserId;

  const StrangerPanel({super.key, required this.targetUserId});
      ...
      child: Row(
        children: [
          ...
          FilledButton.tonal(
              ...
              result.fold(
                ...
                (_) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text(l10n.success_friend_request_sent)),
                  );
                },
              );
            },
            ...
            child: Text(l10n.action_add_friend),
          ),
        ],
      ),
    );
